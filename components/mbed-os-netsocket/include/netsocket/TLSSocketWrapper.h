...
public:
     ...
     */
    explicit TLSSocketWrapper(TCPSocket *transport,
...
protected:
     ...
     *                See @ref mbedtls_ctr_drbg_seed or @ref mbedtls_hmac_drbg_seed, @ref mbedtls_ssl_setup. @ref
